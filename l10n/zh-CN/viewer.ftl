...
pdfjs-editor-color-picker-rectangle-input =
    .title = 更改矩形颜色
pdfjs-editor-geoshape-button =
    .title = 几何
pdfjs-editor-geoshape-button-label = 几何
pdfjs-editor-geoshape-rect-button =
    .title = 矩形
pdfjs-editor-geoshape-circ-button =
    .title = 圆形
pdfjs-editor-geoshape-arrow-button =
    .title = 箭头
...
pdfjs-editor-geoshape-color-input = 颜色
pdfjs-editor-geoshape-thickness-input = 粗细
pdfjs-editor-geoshape-opacity-input = 不透明度
